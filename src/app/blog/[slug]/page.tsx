...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (diary) {
    return <ResearchDiary diary={diary} />;
  }
  ...
  return (
    <div className="min-h-screen pb-20">
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="prose prose-lg max-w-none prose-headings:font-bold prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-purple-600 hover:prose-a:text-purple-700 prose-img:rounded-xl prose-img:shadow-lg">
          <p className="text-xl text-gray-600 mb-12 font-medium italic leading-relaxed">
            {blog.excerpt}
          </p>
